...
[![Tests Passing](https://img.shields.io/badge/Tests-159%2F159%20Passed-brightgreen.svg)](backend/tests/)
...
2. **Edge AI & DeepSORT Tracking (Phase 2)**: YOLOv8 real-time object classification and DeepSORT Kalman filter state trajectory tracking.
...
15. **Production Hardening, Scalability & Demo Engine (Phase 15)**: Liveness/readiness probes, metrics, data retention lifecycle, and deterministic 16-step demonstration engine.
...
Run the full automated test suite (159+ tests across all 15 phases):
```bash
# Run all tests
python -m pytest backend/tests

# Run Phase 15 Hardening & Demo Suite
python -m pytest backend/tests/test_phase15_hardening.py
```
