...
export const SecurityEventsPage: React.FC = () => {
  ...
  return (
    <div className="p-3 sm:p-4 md:p-6 space-y-4 sm:space-y-6 max-w-full overflow-x-hidden">
      {/* Top Banner */}
      <div className="bg-gradient-to-r from-[#21121d] via-[#0f172a] to-[#0d131f] border border-[#3b192e] rounded-2xl p-4 sm:p-6 shadow-2xl flex flex-col md:flex-row md:items-center justify-between gap-4">
