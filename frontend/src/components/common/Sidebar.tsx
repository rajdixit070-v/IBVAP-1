...
export const Sidebar: React.FC<SidebarProps> = ({ activeTab, setActiveTab }) => {
  ...
  return (
    <aside className="w-64 bg-[#0d131f] border-r border-[#1e293b] flex flex-col justify-between select-none">
      {/* Navigation Links */}
      <div className="p-4 space-y-1">
        <div className="text-[10px] font-mono text-slate-400 uppercase tracking-widest px-3 py-2">
          OPERATIONAL MODULES
        </div>
      ...
      {/* Footer Info */}
      <div className="p-4 border-t border-[#1e293b] bg-[#0a0e17]/50">
